...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_split_3x6_3(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
                                  KC_LCMD, MO(_NUM), KC_LCTL,                   KC_SPC, MO(_FN), KC_RALT
    ),
     ...
     * |------+------+------+------+------+------+------+------|            |------+------+------+------+------+------+------|
     * | cmd |  xxx | ctrl|                                         | space |  xxx | RAlt|
     * `------------------------------------------------'                    `------------------------------------------------'
     */
    [_NUM] = LAYOUT_split_3x6_3(
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL,
        KC_TAB,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                     KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_NO,   KC_BSLS,
        KC_LSFT, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                     KC_NO,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_NO,
                                  KC_LCMD, KC_NO,   KC_LCTL,                    KC_SPC, KC_NO,   KC_RALT
    ),
     ...
     * |------+------+------+------+------+------+------|                    |------+------+------+------+------+------+------|
     * | Shift| mute | vol+ | vol- | sshot|  xxx |                          |  xxx |  xxx |  xxx |  xxx |  xxx |  xxx |
     * |------+------+------+------+------+------+------+------|            |------+------+------+------+------+------+------|
     * | cmd |  xxx | ctrl|                                       | space |  xxx | RAlt |
     * `------------------------------------------------'                    `------------------------------------------------'
     */
    [_FN] = LAYOUT_split_3x6_3(
        ...
        KC_LSFT, KC_MUTE, KC_VOLU, KC_VOLD, KC_PSCR, KC_NO,                     KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
                                  KC_LCMD, KC_NO,   KC_LCTL,                    KC_SPC, KC_NO,   KC_RALT
    )
};
